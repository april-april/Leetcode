def maxSlidingWindow(nums, k):
    ...
    slideTimes = len(nums) - k + 1
    slideWindowMax = []
    for i in range(slideTimes):
        temp_window = nums[i:i+k]
        slideWindowMax.append(max(temp_window))
...
def main():        
    ...
    maxSlide = Solution()
    print(maxSlide.maxSlidingWindow2([1,3,-1,-3,5,3,6,7], 3))
